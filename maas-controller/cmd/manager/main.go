...
func main() {
	...
	flag.Int64Var(&authzCacheTTL, "authz-cache-ttl", 60, "TTL in seconds for Authorino authorization caching (auth-valid, subscription-valid, require-group-membership, unmetered-sar).")
